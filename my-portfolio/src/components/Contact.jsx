const socialLinks = [
  {
    href: "https://github.com/saloniredij",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/saloni-redij/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg: items-stretch">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-zinc-50/5
        ...
        <form
          action="https://getform.io/f/agdlomvb"
          method="POST"
